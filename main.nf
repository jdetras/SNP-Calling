 ...
 */
params.genome = "$projectDir/data/reference/Chr7.fasta"
...
genome_dic = file(params.reference + "/Chr7.dict")
...
workflow{
	...
	haplotype_caller(params.genome, genome_fai, genome_dic, merge_bam.out)
}
